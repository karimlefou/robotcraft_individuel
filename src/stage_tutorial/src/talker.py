...
class TalkerClass:
    def __init__(self):
       ...
       #self.publisher1 = rospy.Publisher("/robot_1/cmd_vel", Twist, queue_size=10)
       #self.subscriber1 = rospy.Subscriber("/robot_1/base_scan", LaserScan, self.callback1)
